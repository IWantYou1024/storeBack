				...
				<TD vAlign=top width="100%" bgColor=#ffffff>
					...
					<TABLE borderColor=#cccccc cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
						<TBODY>
							<TR>
								<TD height=25>
<s:form action="findAllCustomer" namespace="/customer" method="post">
<TABLE cellSpacing=0 cellPadding=2 border=0>
	<TBODY>
		<TR>
<TD>客户名称：</TD>
<TD>
<s:textfield name="custName" class="textbox" id="sChannel2" style="WIDTH: 80px" maxLength="50"></s:textfield>
<TD>客户来源：</TD>
<TD>
<s:select class="textbox" id="sChannel2" style="WIDTH: 180px" list="%{customerSources}"
 headerKey="" headerValue="---请选择---"
	listKey="dictId" listValue="dictItemName" name="customerSourceId"></s:select>

</TD>
<TD>客户级别：</TD>
<TD>
<s:select class="textbox" id="sChannel2" style="WIDTH: 180px" list="%{customerLevels}" headerKey="" headerValue="---请选择---"
	listKey="dictId" listValue="dictItemName" name="customerLevelId"></s:select>
</TD>
<TD>所属行业：</TD>
<TD>
<s:textfield name="custIndustry" class="textbox" id="sChannel2" style="WIDTH: 80px" maxLength="50"></s:textfield>
												...
												<TR style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													...
													<%--
														...
														s:param : 参数传递
															...
															value：取值
													 --%>
													 <s:a action="editCustomerUI" namespace="/customer">
													...
													<%--
														struts2的超链接标签
															要写OGNL标签:ognl表达式一定要写完整
																
													 --%>
													 <s:a href="#" onclick="deleteCustomer('%{custId}')">删除</s:a>
													</TD>
												</TR>													
											</s:iterator>
										</TBODY>
