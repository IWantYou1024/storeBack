    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="shipper" /></td>
	            <td class="columnTitle">运输方式：</td>
	            <td class="tableContent"><input type="text" name="orderType" /></td>
	        </tr>
	        <tr>
	            <td class="columnTitle">提单抬头</td>
	            <td class="tableContent"><input type="text" name="consignee" /></td>
	            <td class="columnTitle">正本通知人</td>
	            <td class="tableContent"><input type="text" name="notifyParty" /></td>
	        </tr>	
	        <tr>
	            <td class="columnTitle">装运港：</td>
	            <td class="tableContent"><input type="text" name="portOfLoading" /></td>
	            <td class="columnTitle">转运港：</td>
	            <td class="tableContent"><input type="text" name="portOfTrans" /></td>
	        </tr>
	        <tr>
	            <td class="columnTitle">目的港：</td>
	            <td class="tableContent"><input type="text" name="portOfDischarge" /></td>
	        ...
	        <tr>
	            ...
	            <input type="radio" name="isBatch"  value="0"/>否
	            <input type="radio" name="isBatch"  value="1"/>是
	            </td>
	        </tr>
	        <tr>
	            <td class="columnTitle">是否转船：</td>
	            <td class="tableContentAuto">
	            <input type="radio" name="isTrans" value="0"/>否
	            <input type="radio" name="isTrans" value="1"/>是
	            </td>
	        </tr>
	        <tr>
	            <td class="columnTitle">份数：</td>
	            <td class="tableContent"><pre><input type="text" name="copyNum" /></pre></td>
	            <td class="columnTitle">扼要说明：</td>
	            <td class="tableContent"><pre><input type="text" name="remark" /></pre></td>
	        </tr>
	        <tr>
	            <td class="columnTitle">运输要求：</td>
	            <td class="tableContent"><pre><input type="text" name="specialCondition" /></pre></td>
	            <td class="columnTitle">运费说明：</td>
	            <td class="tableContent"><input type="text" name="freight" /></td>
	        </tr>
		</table>
	</div>
