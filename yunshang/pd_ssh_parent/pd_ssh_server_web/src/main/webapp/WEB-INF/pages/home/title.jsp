...
//			alert((0-currLeft) <= maxOffset);
		...
		function logout(){
			//return formSubmit("", "_top");
			self.top.location.href="${ctx}/loginAction_logout";
			return false;
		}
...
<div class="PositionFrame_black" id="PositionFrame"></div>
	...
	<a id="logins" style="cursor:pointer;" onclick="lookSelfInfo();" title="点击显示您的登录信息"><div id="small_login" class="small_login" title="点击显示您的登录信息"></div></a>
