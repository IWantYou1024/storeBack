 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://test.cxf.itcast.cn/", wsdlLocation = "http://localhost:12345/user?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://test.cxf.itcast.cn/", "UserServiceImplService");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://test.cxf.itcast.cn/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test.cxf.itcast.cn/", "UserServiceImplPort"), UserService.class, features);
    }
